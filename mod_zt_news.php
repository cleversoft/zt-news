...
$showImageList        = $params->get('is_image_list', 1);
$showInfoList         = $params->get('show_info_list', 1);
$showInfo2List        = $params->get('show_info2_list', 0);
// $showSubCategory = $params->get('is_subcat', 1);
$wrapContent          = $params->get('wrap_content', 1);
